...
Каждый график - это зависимость **сверхдоходности** относительно классической пассивной стратегии **и APR**.
...
Соответственно, именно от этих цифр будет считаться относительная сверхдоходности. Т.е. <u>сверхдоходность бивалютной стратегии</u> = `(dualAssentResultValue - passiveResultValue) / passiveResultValue * 100`.
...
#### Выводы
**Самая доходная стратегия**: #3 с холдом 1 день, но стратегия #4 с холдом в 5 дней тоже показала неплохой результат.
...
Я провёл дополнительные исследования данной стратегии на различных наборах монет, и результаты оказались близки к тем, что были получены на первоначальных графиках. Аномалий не обнаружено, отрицательная сверхдоходность не зафиксирована.

# Итоги
### <u>Объективные</u> итоги:
* Некоторые стратегии бивалютных инвестиций в прошлом могли принести результат лучше, чем классическое инвестирование.
* Стратегия #4 с холдом 5d не приносила отрицательной сверходоходности для наших данных.
* Успех в прошлом не гарантирует успеха в будущем.
* В работе возможны недочеты, не учтены комиссии и прочие издержки, а так же не учтены APR для каждой монеты отдельно.

### <u>Субъективные</u> итоги:
* Бивалютное инвестирование можно попробовать по стратегии #4 с холдом в 5 дней, но на небольшую часть портфеля; 
* Доходность по этой стратегии может быть как выше, так и ниже, т.к. APR всегда меняется и уникален для каждой монеты
* Я бы советовал брать монеты из топа капитализации, для максимального повторения рынка и меньшей волатильности. 
* Крипторынок сейчас ведёт себя совершенно другим образом, нежели 4 года назад. Пониженная волатильность может положительно сказаться на доходности.